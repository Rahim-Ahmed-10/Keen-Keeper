...
const Footer = () => {
    ...
    <div>
    <h1 className='font-bold text-4xl text-white'>KeenKeeper</h1>  
  ...
  <div className='flex flex-col item-center border-t border-white p-2 text-white md:flex-row gap-20 '>
  <aside>
